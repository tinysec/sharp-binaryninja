...
{
	public abstract class AbstractMediumLevelILSSACallInstruction : MediumLevelILInstruction
	{
		internal AbstractMediumLevelILSSACallInstruction(
		...
		public abstract MediumLevelILSSAVariable[] Output { get; }
